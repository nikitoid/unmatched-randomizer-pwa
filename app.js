...
$(document).ready(function () {
  ...
  function showNotification(message, type = "error", duration = 4000) {
    ...
    const notificationDiv = $(
      `<div id="${notificationId}" style="z-index: 200;" class="fixed top-0 left-1/2 -translate-x-1/2 w-full max-w-sm p-4 ${color} text-white rounded-b-lg shadow-lg transition-all duration-300 text-center">${message}</div>`
    );
